...
/* Actual period: 0.065536 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x6400,
  .duty_cycle_counts = 0x3200, .source_div = (timer_source_div_t) 8, .channel = 6, .p_callback = g_timer_callback,
...
{ .mode = TIMER_MODE_PERIODIC,
/* Actual period: 0.065536 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x6400,
  .duty_cycle_counts = 0x3200, .source_div = (timer_source_div_t) 8, .channel = 4, .p_callback = g_timer_callback,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
...
{ .mode = TIMER_MODE_PERIODIC,
/* Actual period: 0.065536 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x640000,
  .duty_cycle_counts = 0x320000, .source_div = (timer_source_div_t) 0, .channel = 3, .p_callback = g_timer_callback,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
